...
public class CinnamonBlock extends Block implements net.minecraftforge.common.IPlantable {
    ...
    public CinnamonBlock(AbstractBlock.Properties properties) {
        super(properties);
    ...
    public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
        ...
        if (blockstate.getBlock() == this) {
            ...
            if (blockstate.isIn(Blocks.PODZOL) || blockstate.isIn(Blocks.SAND) || blockstate.isIn(Blocks.RED_SAND)) {
