...
public abstract class ModBlocks {
    ...
    public static final RegistryObject<Block> WARPED_NETHER_BRICK_WALL = BLOCKS.register("warped_nether_brick_wall", () -> new WallBlock(Block.Properties.from(ModBlocks.WARPED_NETHER_BRICKS.get())));
    public static final RegistryObject<Block> WARPED_NETHER_BRICK_SLAB = BLOCKS.register("warped_nether_brick_slab", () -> new SlabBlock(Block.Properties.from(ModBlocks.WARPED_NETHER_BRICKS.get())));
    public static final RegistryObject<Block> WARPED_NETHER_BRICK_STAIRS = BLOCKS.register("warped_nether_brick_stairs", () -> new StairsBlock(()-> ModBlocks.WARPED_NETHER_BRICKS.get().getDefaultState(),Block.Properties.from(ModBlocks.WARPED_NETHER_BRICKS.get())));
    ...
    public static final RegistryObject<Block> CRIMSON_WALL_TORCH = BLOCKS.register("crimson_wall_torch", () -> new WallTorchBlock(AbstractBlock.Properties.create(Material.MISCELLANEOUS).doesNotBlockMovement().zeroHardnessAndResistance().setLightLevel((p_235465_0_) -> {
        return BlockLightingRegistries.soul_fire;
    }).sound(SoundType.WOOD).lootFrom(ModBlocks.CRIMSON_TORCH.get()), ParticleTypes.REVERSE_PORTAL));
}
