...
public class CrimsonBerries extends BushBlock implements IGrowable {
    ...
    public CrimsonBerries() {
        super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.SWEET_BERRY_BUSH));
